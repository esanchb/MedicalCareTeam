...
#define ECG_FIR       //uncomment this to use FIR

#if (defined ECG_DSC && defined ECG_FIR)
#error "Just one Filtering method can be defined, check Ecg.h"
#endif
...
#define	ADC_CHANNEL_FEEDBACK_SIGNAL		8	//baseline (instrumentation amplification output) signal
